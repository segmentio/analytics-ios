...
- (void)testIdentifyWithMultipleCredentialsAndTraits
{
    [_integration identify:@"foo" traits:@{ @"bar" : @"baz",
                                            KAHUNA_CREDENTIAL_EMAIL : @"segkah@gmail.com", @"moon" : @"drake" }
                   options:@{}];
...
{
    [_integration track:@"foo" properties:@{ @"revenue" : @10,
                                             @"quantity" : @4 }
                options:nil];
...
- (void)testTrackWithPropertyViewedCategory
{
    ...
    [verifyCount(_kahunaClassMock, times(1)) setUserAttributes:@{ KAHUNA_LAST_VIEWED_CATEGORY : @"shirts",
                                                                  KAHUNA_CATEGORIES_VIEWED : @"shirts" }];
