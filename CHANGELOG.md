...
-------------------------------------
* [Fix] `Application Updated` event firing more often than normal due to string comparison
* [Fix] `context.network.carrier` setting not showing up because it's over-written.
