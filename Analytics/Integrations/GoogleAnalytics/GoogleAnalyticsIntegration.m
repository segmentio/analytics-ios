...
@implementation GoogleAnalyticsIntegration

#pragma mark - Initialization

+ (void)load {
    [Analytics registerIntegration:self withIdentifier:@"Google Analytics"];
}
...
- (void)start {
    ...
    // All done!
    SOLog(@"GoogleAnalyticsIntegration initialized.");
}
...
- (void)track:(NSString *)event properties:(NSDictionary *)properties options:(NSDictionary *)options
{
    ...
    NSNumber *value = [AnalyticsIntegration extractRevenue:properties];
    NSNumber *valueFallback = [AnalyticsIntegration extractRevenue:properties withKey:@"value"];
