...
@implementation CountlyIntegration

#pragma mark - Initialization

+ (void)load {
    [Analytics registerIntegration:self withIdentifier:@"Countly"];
}
...
- (void)start
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        SOLog(@"CountlyIntegration initialized with appKey %@ and serverUrl %@", appKey, serverUrl);
    });
}
