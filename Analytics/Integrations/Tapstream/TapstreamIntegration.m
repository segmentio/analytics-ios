...
@interface TapstreamIntegration()
- (TSEvent *)makeEvent:(NSString *)event properties:(NSDictionary *)properties options:(NSDictionary *)options;
@end

@implementation TapstreamIntegration

#pragma mark - Initialization

+ (void)load {
    [Analytics registerIntegration:self withIdentifier:@"Tapstream"];
}
...
- (void)start
{
    ...
    SOLog(@"TapstreamIntegration initialized with accountName %@ and developerSecret %@", accountName, sdkSecret);
}
