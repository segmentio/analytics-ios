...
@implementation LocalyticsIntegration
...
+ (void)load {
    [Analytics registerIntegration:self withIdentifier:@"Localytics"];
}
...
- (void)start
{
    ...
    SOLog(@"LocalyticsIntegration initialized.");
}
...
- (void)identify:(NSString *)userId traits:(NSDictionary *)traits options:(NSDictionary *)options
{
    ...
    if (!email && [LocalyticsIntegration validateEmail:userId]) {
        email = userId;
    }
    if (email) {
